...
Raise your hands. Bend the sound. Wink at your own risk.
...
music,instrument,gesture,synthesizer,hand tracking,face,wink,creative,sound,theremin

## Review notes

AirBand uses ARKit face tracking and Vision hand-pose detection on-device. To test Camera mode, prop a supported Face ID iPhone upright with the user's face and hands visible. Touch mode provides the complete sound engine and simulated controls without camera input.
